...
public class BlueBall extends JComponent implements ActionListener, MouseMotionListener, KeyListener {
    ...
    public static void main(String[] args) {
        ...
        JFrame wind = new JFrame("BlueBall");
        BlueBall g = new BlueBall();
        wind.add(g);
        wind.pack();
